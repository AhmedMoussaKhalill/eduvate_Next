...
import { ShoppingBag, Home, Package, ShoppingCart } from 'lucide-react';
...
export const BagIcon = () => <ShoppingBag className="h-5 w-5 text-gray-800" />;

export const CartIcon = () => (
  <ShoppingCart className="h-5 w-5 text-gray-800" />
);

export const BoxIcon = () => <Package className="h-5 w-5 text-gray-800" />;

export const HomeIcon = () => <Home className="h-5 w-5 text-gray-800" />;
